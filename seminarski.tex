...
Najrazli\v citije fazi tehnike omogu\' cavaju odgovaraju\' ci okvir za napredak jer su zasnovane na znanju (eng. knowledge-based). [4] \\ 
Mogu da obrade podatke sa gre\v skom u sluc\v aju da je ista nastala usled neodredjenosti (eng. vagueness) i dvosmislenosti (eng. ambiguity) (ali ne zbog nasumi\v cnosti (eng. randomness)). [4]
\\ \\ 
...
i defazifikacija. Prva i poslednja faza su neophodne zbogtoga \v sto ne postoji odgovaraju\' ci fazi hardver.
\\ \\ 
